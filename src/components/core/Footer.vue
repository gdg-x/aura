        ...
        <v-col cols="12" md="10" lg="10" sm="10" class="my-0 py-0">
          <v-container fluid class="pa-0 my-0">
            ...
            <v-row align="center" justify="start" class="">
              <v-col cols="12" md="3" lg="4" sm="3" class="py-2" v-for="(item,i) in FooterData.Links" :key="i">
                <div v-for="(itemp,j) in item" :key="j" class="mt-1">
                  <p class="google-font mb-0" style="font-size: 140%;font-weight: 300;"><b>{{j}}</b></p>
                  <div v-for="(linkdata,k) in itemp" :key="k">
                    <a :href="linkdata.Link" :class="$vuetify.theme.dark?'darkThemeTextLink':'lightThemeTextLink'" class="google-font" target="_blank" style="text-decoration: none;font-size:110%">{{linkdata.LinkName}}</a><br>
                  </div>
                </div>
              </v-col>
            </v-row>
      ...
      <v-row align="center" justify="center" class="mb-0">
        <v-col cols="12" md="10" lg="10" sm="10" class="px-0 mx-0"> 
          ...
          <v-toolbar text class="pa-0 px-0 mt-3 mx-0 elevation-0" style="padding:0 !important" :class="this.$vuetify.theme.dark == true?'grey darken-4':'white'">
            <v-toolbar-title class="google-font pl-0 ml-0 mr-3" style="font-size:200%">GDG Jalandhar</v-toolbar-title>
