          ...
          <p class="google-font mt-4 mb-3" style="font-size:130%" >Follow Us:
              <v-tooltip top>
                 <template v-slot:activator="{ on }">
                    <v-btn text icon v-on="on" :href="socialLinks.facebook" target="_blank" slot="activator">
              ...
              <v-tooltip top>
                 <template v-slot:activator="{ on }">
                    <v-btn text icon v-on="on" :href="socialLinks.twitter" target="_blank" slot="activator">
              ...
              <v-tooltip top>
                 <template v-slot:activator="{ on }">
                    <v-btn text icon v-on="on" :href="socialLinks.instagram" target="_blank" slot="activator">
              ...
              <v-tooltip top>
                 <template v-slot:activator="{ on }">
                    <v-btn text icon v-on="on" :href="socialLinks.github" target="_blank" slot="activator">
              ...
              <v-tooltip top>
                 <template v-slot:activator="{ on }">
                    <v-btn text icon v-on="on" :href="socialLinks.medium" target="_blank" slot="activator">
