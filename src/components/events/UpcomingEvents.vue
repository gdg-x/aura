<template>
    <v-container fluid>
        ...
        <v-row align="center" justify="center" :style="{'background-image':'url('+require('@/assets/img/svg/bg.svg')+')'}"
      style="background-position:right">
            <v-col cols="12" md="12" lg="12" sm="12" class="">
                <p class="google-font mb-0" style="font-size:150%;color: #1a73e8;">Upcoming Events</p>
                <p class="google-font mt-0" style="font-size:95%">Our events are open to newbies, developers, managers, and organizations who are interested in Google's technologies or use them as part of their projects.</p>
                ...
                <v-row v-else>
                    <v-col md="3" lg="3" sm="6" cols="12" class="pa-2" v-for="(item,i) in eventsData" :key="i">
                ...
                <v-row v-if="notFoundUpcomingEventFlag" class="pa-2">
                    <v-col md="3" lg="3" sm="6" cols="12" class="pa-3" :class="$vuetify.theme.dark == true?'darkModeCard':'card-light'" >
...
import upcomingEventCard from '@/components/events/UpcomingEventCard'
    export default {
        ...
        methods:{
            getMeetupUrl(){
                service.getAllUpcomingMeetupsEvents().then(res=>{
                    if(res.success){
