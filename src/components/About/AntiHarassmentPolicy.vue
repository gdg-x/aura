        ...
        <v-row class="py-0 my-0">
            <v-col md="8" sm="8" cols="12" class="py-0 my-0">
                <p class="google-font" style="font-size:110%">
                    <b style="font-size:120%;">Why do we have an official Anti-Harassment policy for {{chapterDetails.ChapterName}} events?</b>
                ...
                <p class="google-font" style="font-size:110%">
                    <b style="font-size:120%;">{{chapterDetails.ChapterName}} is dedicated to providing a harassment-free event experience for everyone, regardless of: </b>
